...
<header class="mb-2 text-center">
  ...
  <h2 class="text-lg font-semibold text-gray-900 mb-4">20-Minute Temporary Email – FAQs</h2>
  <div class="space-y-4 text-sm text-gray-600">
    ...
    <div class="pb-4 border-b border-gray-100">
      <h3 class="text-base font-medium text-gray-800">Is it really free?</h3>
      <p class="mt-2">Yes, it's 100% free to use. No registration or payment needed.</p>
    </div>

    <div class="pb-4 border-b border-gray-100">
      <h3 class="text-base font-medium text-gray-800">Can I use it to receive OTPs and verification emails?</h3>
      <p class="mt-2">Yes. You can receive one-time passwords, activation links, and other verification emails safely.</p>
    </div>

    <div class="pb-4 border-b border-gray-100">
      <h3 class="text-base font-medium text-gray-800">Will the email address delete itself?</h3>
      <p class="mt-2">Yes. All emails and the inbox itself are automatically deleted after 20 minutes.</p>
    </div>

    <div class="pb-4 border-b border-gray-100">
      <h3 class="text-base font-medium text-gray-800">Is my identity protected?</h3>
      <p class="mt-2">Absolutely. We do not track or store any personal information. Your privacy is our priority.</p>
    </div>
